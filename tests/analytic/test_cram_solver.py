...
def test_single_decay():
    ...
    def deplete_substeps(num_substeps, cram_order, lib, ref_soln):
        exec_cmd = ""
        num_threads = 1
        num_procs = 1
    ...
    deplete_substeps(4, 16, depllib, ref_soln)
    deplete_substeps(4, 48, depllib, ref_soln)
...
def test_branch_decay():
    ...
    def deplete_substeps(num_substeps, cram_order, lib, ref_val):
        exec_cmd = ""
        num_threads = 1
        num_procs = 1
        # Initialize our depletion solver
    ...
    deplete_substeps(4, 16, depllib, ref_val)
    deplete_substeps(4, 48, depllib, ref_val)
...
def test_fission_yield_decay():
    ...
    def deplete_substeps(num_substeps, cram_order, lib, ref_vals):
        exec_cmd = ""
        num_threads = 1
        num_procs = 1
        # Initialize our depletion solver
    ...
    deplete_substeps(4, 16, depllib, ref_vals)
    deplete_substeps(4, 48, depllib, ref_vals)
...
def test_multi_fission_yield():
    ...
    def deplete_substeps(num_substeps, cram_order, lib, isos, ref_soln):
        exec_cmd = ""
        num_threads = 1
        num_procs = 1
        # Initialize our depletion solver
    ...
    deplete_substeps(4, 16, depllib, isos, ref_soln)
    deplete_substeps(4, 48, depllib, isos, ref_soln)
...
def test_burn_actinide():
    ...
    def deplete_substeps(num_substeps, cram_order, lib, targets, ref_soln):
        exec_cmd = ""
        num_threads = 1
        num_procs = 1
        # Initialize our depletion solver
    ...
    deplete_substeps(4, 48, depllib, targets, ref_soln)
...
def test_burn():
    ...
    ref_soln = np.array(
        [[1.438612560895150E+22, 1.438612560895150E+22, 1.438612560895150E+22,
          1.438612560895150E+22, 1.810527922756180E+23, 1.438612560895150E+22,
          1.810527922756180E+23, 1.810527922756180E+23, 1.810527922756180E+23,
          8.034991301295710E+22, 1.810527922756180E+23],
         [2.132166925658800E+22, 2.132166925658800E+22, 2.132166925658800E+22,
          2.132166925658800E+22, 1.879883359232540E+23, 2.132166925658800E+22,
          1.879883359232540E+23, 1.879883359232540E+23, 1.879883359232540E+23,
          3.873665112713860E+22, 1.879883359232540E+23],
         [2.466529122929890E+22, 2.466529122929890E+22, 2.466529122929890E+22,
          2.466529122929890E+22, 1.913319578959650E+23, 2.466529122929890E+22,
          1.913319578959650E+23, 1.913319578959650E+23, 1.913319578959650E+23,
          1.867491929087310E+22, 1.913319578959650E+23],
         [2.627724963723210E+22, 2.627724963723210E+22, 2.627724963723210E+22,
          2.627724963723210E+22, 1.929439163038980E+23, 2.627724963723210E+22,
          1.929439163038980E+23, 1.929439163038980E+23, 1.929439163038980E+23,
          9.003168843273920E+21, 1.929439163038980E+23],
         [2.705437394437970E+22, 2.705437394437970E+22, 2.705437394437970E+22,
          2.705437394437970E+22, 1.937210406110460E+23, 2.705437394437970E+22,
          1.937210406110460E+23, 1.937210406110460E+23, 1.937210406110460E+23,
          4.340423000388150E+21, 1.937210406110460E+23],
         [2.742902516725710E+22, 2.742902516725710E+22, 2.742902516725710E+22,
          2.742902516725710E+22, 1.940956918339230E+23, 2.742902516725710E+22,
          1.940956918339230E+23, 1.940956918339230E+23, 1.940956918339230E+23,
          2.092515663123760E+21, 1.940956918339230E+23]])
