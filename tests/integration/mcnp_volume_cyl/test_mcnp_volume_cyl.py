...
ksrc -0.20 0 0 0.20 0.20 0 0 -0.20 0 0 0 0 0 -0.5 0 0 0.5
kcode 1000 1.18 20 300
print 38 60 128 130

"""

# This test is similar to the other volume test, except here:
# - a cylindrical source/bounding box is used
# - it will have to iterate.
# These are done to check additional lines compared to the other test
...
class VolumeHarness(TestHarness):
    ...
    def _compare_results(self):
        ref_vols = np.array([0.333333, 2., 0.333333, 1., 0.303394,
                             1.667284])
        ref_tols = np.array([0., 0., 0., 0., 0., 0.13 / 100.])
